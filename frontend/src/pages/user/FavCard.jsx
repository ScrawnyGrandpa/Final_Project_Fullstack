...
export default function FavCard({ object }) {
    ...
    return (
        <div className="border bg-black mb-3 rounded border-[#212930] transition-transform duration-300 ease-in-out transform scale-100 hover:scale-[1.04] hover:border-blue-500 opacity-80 hover:opacity-100">
            <Link
                key={object._id}
